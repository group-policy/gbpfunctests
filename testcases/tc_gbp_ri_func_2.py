...
class test_gbp_ri_func_2(object):
    ...
    def run(self):
        ...
        if l3p_uuid == 0:
            ...
            self.cleanup('l3p', l3p_uuid,
                         tc_name='TESTCASE_GBP_RI_FUNC_2A', fail=1)
        ######
        ...
        # order.. but it kept it simple. l2p_uuid[1] is same as l3p_uuid, just
        # that cfg_all func returns both uuid when l2p is obj
        ...
        if self.gbpcfg.gbp_policy_cfg_all(0, 'l3p', l3p_uuid) != 0:
            ...
            self.cleanup(
                objs, names, tc_name='TESTCASE_GBP_RI_FUNC_2A', fail=1)
        else:
        ...
        if uuids != 0:
            ...
            self.cleanup(
                objs, names, tc_name='TESTCASE_GBP_RI_FUNC_2B', fail=1)
