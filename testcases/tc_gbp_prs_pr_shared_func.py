...
class test_gbp_prs_pr_shared_func(object):
    ...
    def test_gbp_prs_pr_shared_func_1(self):
        ...
        if self.gbpverify.gbp_policy_verify_all(1, 'ruleset', ruleset_uuid, name='grppol_prs_many',
            ...
            self._log.info(
                "# Step 2B: Verify Policy RuleSet and its shared='False' == Failed")
            return 0
        ...
        if self.gbpcfg.gbp_policy_cfg_all(2, 'ruleset', 'grppol_prs_many', shared='True') != 0:
            self._log.info(
                "# Step 3: Updating Policy RuleSet's Attribute shared=True DID NOT Fail")
            return 0
        if self.gbpverify.gbp_obj_ver_attr_all_values('ruleset', 'grppol_prs_many', 'policy_rules', rule_uuid_list) != 0:
            self._log.info(
                "# Step 3A: Verify Policy RuleSet and its Multiple PRs, == Failed")
            return 0
        if self.gbpverify.gbp_policy_verify_all(1, 'ruleset', ruleset_uuid, name='grppol_prs_many',
                                                description='For devstack demo', shared='False') == 0:
            self._log.info(
                "# Step 3B: Verify Policy RuleSet and its shared=False, == Failed")
            return 0
    ...
    def test_gbp_prs_pr_shared_func_2(self):
        ...
        if self.gbpcfg.gbp_policy_cfg_all(2, 'ruleset', 'grppol_prs_many', shared='True') == 0:
            self._log.info(
                "# Step 3: Updating Policy RuleSet's Attribute shared=True , Failed")
            return 0
        if self.gbpverify.gbp_obj_ver_attr_all_values('ruleset', 'grppol_prs_many', 'policy_rules', rule_uuid_list) != 0:
            self._log.info(
        ...
        if self.gbpverify.gbp_policy_verify_all(1, 'ruleset', ruleset_uuid, name='grppol_prs_many',
            ...
            self._log.info(
                "# Step 3B: Verify Policy RuleSet and its shared=True, == Failed")
            return 0
